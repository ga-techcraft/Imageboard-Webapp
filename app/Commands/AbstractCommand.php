...
// 流れ図
// (1) ターミナルから渡された $argv を取得
//     ↓
// (2) コマンド名（例: greet）を探す
//     ↓
// (3) コマンド名のすぐ後ろに「コマンド値」があるか確認
//     ・値があれば保存
//     ・なければオプション解析に進む
//     ↓
// (4) 残りの引数を全部見ていく
//     ・--xxx や -x をオプション名として拾う
//     ・直後に値があればセットする
//     ↓
// (5) コマンドクラスが定義している Argument リストと照らし合わせる
//     ・存在するか
//     ・必須かどうか
//     ・短縮形を許してるか
//     ↓
// (6) 最終的に argsMap を完成させる
//     ↓
// (7) デバッグ用に argsMap をjsonで出力
